"""
Strategy 006/approach_B — LSTM Momentum
...
class Strategy006ApproachB:
    """LSTM Momentum — BUY on multi-timeframe RSI crossover with SMA trend alignment."""
    ...
    def get_entry_signal(self, tick: dict) -> dict:
        ...
        BUY CE when: RSI(9) > 60 AND RSI(14) > 55 AND SMA20 > SMA50
        ...
        # Buy CE: fast RSI + slow RSI + uptrend confirmation
        if rsi9 > 60 and rsi14 > 55 and sma20 > sma50:
            ...
            if ce_p > 30:
                return {
                    ...
                    "lots": 1,
                    "confidence": 0.70,
                    "reason": f"LSTM: RSI9={rsi9:.1f}, RSI14={rsi14:.1f}"
                }

        # Buy PE: fast RSI + slow RSI + downtrend confirmation
        if rsi9 < 40 and rsi14 < 45 and sma20 < sma50:
            atm = self.get_atm_strike(price, 100)
